...
SRC = modules.f90 SPmain.f90 PBC.f90 parser.f90 init.f90 allocation.f90 allocatencha.f90 allocateell.f90 3D.f90  allocatecpp.f90  cadenas.f90  fe.f90  fkfun.f90  kai.f90  kinsol.f90  pxs.f90  savetodisk.f90 rands2.f90 ellipsoid.f90 dielectric.f90 transform.f90 testsystem.f90
